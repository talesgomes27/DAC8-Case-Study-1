...
bikeshare_summary <- bikeshare_data |>
  ...
  describe(descript = "Statistical Description Summary")
...
-   Regarding the difference in usage between members and casual users, we can observe the following:
    ...
    -   The trip duration is 145% longer for Casual Users. Averaging 36.15 min for casual users and 14.71 min for members;
...
### Key findings
 ...
 - Also have the mean duration of the trips 145% higher than members;
